...
{ 
 /*
 * This a exact copy of: https://github.com/giacomelli/GeneticSharp/blob/master/src/GeneticSharp.Extensions/Tsp/TspChromosome.cs
 */
	...
	public class TspChromosome : ChromosomeBase
    {
        ...
        {
            return "(Distance: " + this.Distance.ToString() + " Fitness: " + this.Fitness + ")";
        }
    }
